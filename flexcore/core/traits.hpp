...
template<class T>
constexpr auto class_is_passive_sink_v = is_passive_sink_v<std::decay_t<T>>;
/**
 * \brief Checks if type T is a passive sink.
 *
...
template<class T>
constexpr auto class_is_passive_source_v = is_passive_source_v<std::decay_t<T>>;
...
template<class T>
constexpr auto class_is_active_sink_v = is_active_sink_v<std::decay_t<T>>;
/**
...
///shortcut for is_active which decays template parameter
template<class T>
constexpr auto class_is_active_source_v = is_active_source_v<std::decay_t<T>>;
...
///shortcut for is_active which decays template parameter
template<class T>
constexpr auto class_is_active_v = is_active_v<std::decay_t<T>>;
