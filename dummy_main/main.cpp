...
//
//	fc::node_aware<fc::event_out_port<std::string>> string_source(first_region);
//	fc::node_aware<fc::event_in_port<std::string>> string_sink(second_region,
