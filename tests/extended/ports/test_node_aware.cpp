...
{
	using no_mixin_sink = node_aware<pure::event_sink<int>>;
	using no_mixin_source = node_aware<pure::event_source<int>>;
	check_mixins<no_mixin_source, no_mixin_sink>();

	using test_mixin_sink = useless_mixin<node_aware<pure::event_sink<int>>>;
	using test_mixin_source = useless_mixin<node_aware<pure::event_source<int>>>;
...
//make sure that traits of ports do not depend on tokent ype
